...
<?php include('templates/layouts/header.php'); ?>
    <section id="index-firstview">
        <div class="index-fv-title">
            ...
            <div class="square index-fv-img" ><img src="<?php echo Path::ROOT . 'assets/img/elephant.jpg' ?>"/>
        </div>
    </section>
            ...
            <div>
                ...
                <div>
                    ...
                    <ul>
                        ...
                        <li>Logics: business logic (bridge between repositories and views)</li>
                        <li>repositories: DB operations (classes)</li>
                    </ul>
                </div>
            </div>
            <div>
            ...
            <div>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <p>Write the process you want to use in the templates file that plays the role of a view, directly under the util folder.</p>
                        <ul>
