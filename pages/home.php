      ...
      <section class="grid-two-block pa-3">
            <div>
                <section class="px-3 py-2">
                    ...
                    <div class="text-left pl-2"><a href="artist">Go</a></div>
                </section>
                <section class="px-3 py-2">
                    <h3>2.Concerts</h3>
                    ...
                    <div class="text-left pl-2"><a href="concert">Go</a></div>
                </section>
                <section class="px-3 py-2">
                    ...
                    <div class="text-left pl-2"><a href="artist_concert">Go</a></div>
                </section>
            </div>
            <div>
                <section class="flex-box justify-center" >
                    <img src="<?php echo Path::ROOT . 'assets/img/home.png' ?>" style="width: 80%">
